...
<head>
    ...
    <title>Site de listes de courses - Nouvelle liste</title>
    ...
    <div class="container">
        ...
        <form action="submit_liste.php" method="POST">
            <div class="mb-3">
                ...
                <input type="text" placeholder="Liste de noël" class="form-control" id="title" name="title" aria-describedby="title-help">
            </div>
            <div class="mb-3">
